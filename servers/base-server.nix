...
in
{
  ...
  security.acme = {
    ...
    # defaults.server = "https://acme-v02.api.letsencrypt.org/directory"; # If staging => not signed
    defaults.server = "https://acme-staging-v02.api.letsencrypt.org/directory"; # If staging => not signed
  };
